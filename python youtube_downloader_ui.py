...
# resizing the logo
resized_logo = logo.subsample(5, 5)
# adding the logo to the canvas
canvas.create_image(250, 80, image=resized_logo)
...
# creating the button
download_button = ttk.Button(window, text='Download Video', style='TButton', command=download_video)
# adding the button to the canvas
